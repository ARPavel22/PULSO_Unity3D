...
public class ScanPorts : MonoBehaviour
{
    ...
    public IEnumerator OpenPortByName(string portName)
    {
        Debug.Log("Open port by name: " + portName);
